...
public class CrudAppTestingApp {
    ...
    public static final String XPATH_TEXTAREA = "//html/body/main/section/from/fieldset[2]/textarea";
    public static final String XPATH_SELECT = "//select[1]";

    public static void main(String[] args){
        WebDriver driver = WebDriverConfig.getDriver(WebDriverConfig.FIREFOX);
        driver.get("https://chupacabra1985.github.io");

        WebElement serachField = driver.findElement(By.xpath(XPATH_INPUT));
        serachField.sendKeys("New robotic task");
